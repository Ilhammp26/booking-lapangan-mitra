        ...
        <div class="col-12">
            <div class="row align-items-center my-3">
                ...
                <div class="col-auto">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#eventModal"><span class="fe fe-plus fe-16 mr-3"></span>Pesan</button>
                </div>
            </div>
            <div id='calendar'></div>
            <!-- new event modal -->
